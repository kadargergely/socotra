...
public class PlayerEntity implements Serializable {
    ...
    @Column(name = "loaded_flag")
    private Boolean loaded;

    public PlayerEntity() {
    }

    public PlayerEntity(int playerId, ServerEntity server, String name, PlayerType type,
            boolean connected, String password, Boolean loaded) {
